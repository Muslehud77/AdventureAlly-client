          ...
          <div className="container mx-auto py-10">
            <div className="flex flex-wrap w-full mb-20">
              ...
              <p className="lg:w-1/2 w-full leading-relaxed text-xl font-light">
                ...
                we showcase new top-rated camping accessories. Discover quality
                gear to enhance your adventures. Don’t miss out - find your next
                must-have item today!
              </p>
            </div>
            <div className="flex flex-wrap w-full justify-center gap-10 items-center text-white">
